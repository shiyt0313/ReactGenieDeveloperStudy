...
const NewTimerFormImpl = (props: {id: string}) => {
    ...
    const [hour, setHour] = useState("Add your code here");
    const [min, setMin] = useState("Add your code here");
    const [sec, setSec] = useState("Add your code here");
    const [content, setContent] = useState("Add your code here");
    const [type, setType] = useState("Add your code here");
...
const TimerItemImpl = (props: {id: string}) => {
    ...
    return (
        <View style={commonStyles.timerItemContainer}>
            ...
            <button style={commonStyles.button} onClick={() => genieDispatch(() => {
...
export const TimerView = () => {
    ...
    const allTimers: // Your code here
    
    const timer : // Your code here

    return (
        <View style={commonStyles.appContainer}>
            <View>
            <div style={commonStyles.timerViewContainer}>
                <button style={commonStyles.button} onClick={() => // Your code here
...
You can sort the timers by time left using `a.createdTime.getDate().getTime() - b.createdTime.getDate().getTime()`
