...
We will briefly introduce the framework of Timer to help you understand how to build Timer applications. 
As a multimodal application, Timer has its own UI and state code. The UI is used to display information and interact,
and the state code is used to store information and execute functions.
