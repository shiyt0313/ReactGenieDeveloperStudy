...
### 2. Study Assignment
#### Build a **MultiTimer** Application with **ReactGenie**
...
of the commands that the user may use. Please implement a MultiTimer app that supports multimodal 
interactions with the help of ReactGenie!

<font color="red">**PIC and CASES here**</font>


##### 2.2 Get a boilerplate of ReactGenie
