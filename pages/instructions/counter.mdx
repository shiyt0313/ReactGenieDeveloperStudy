...
Note: **You don't need to create any HelperClass today.** However, you will need to use predefined HelperClass (i.e., <font color="red">`TimeDelta`</font>) for creating complex properties in your DataClass.
...
Below is an example of a static list in GenieClass. <font color="red">
You only need to give out the name of the parameters in the cases, and do not wrap them with the curly brackets. </font>
```typescript
//Right
